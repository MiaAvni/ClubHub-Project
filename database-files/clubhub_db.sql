...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (9, 1, '502 Bad Gateway', 'Performed a system restore', '2025-12-30 09:05:57', '2025-12-31 22:13:30', 10);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (8, 7, '429 Too Many Requests', 'Reinstalled the application', '2025-12-28 04:39:21', '2025-12-29 04:37:51', 16);
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (4, 6, '404 Not Found', 'Restarted the system', '2024-01-31 19:33:29', '2025-05-10 16:43:12', 89);
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (5, 5, '408 Request Timeout', 'Reviewed error logs', '2025-11-03 08:38:19', '2025-11-08 18:43:34', 40);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (4, 9, '403 Forbidden', 'Reviewed error logs', '2025-01-22 01:24:44', '2025-01-22 04:33:50', 27);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (7, 7, '500 Internal Server Error', 'Performed a system restore', '2025-11-01 06:40:50', '2025-11-03 09:55:39', 1);
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (6, 5, '408 Request Timeout', 'Reinstalled the application', '2025-11-29 10:15:42', '2025-11-30 10:10:26', 64);
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (2, 7, '429 Too Many Requests', 'Reinstalled the application', '2025-09-27 19:11:52', '2025-09-30 08:12:11', 18);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (1, 7, '404 Not Found', 'Reinstalled the application', '2025-11-11 23:02:32', '2025-11-26 18:46:37', 59);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (3, 8, '400 Bad Request', 'Restarted the system', '2025-12-12 00:11:21', '2025-12-15 19:42:56', 12);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (5, 10, '404 Not Found', 'Restarted the system', '2025-11-16 21:26:29', '2025-11-25 20:30:28', 91);
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (10, 4, '400 Bad Request', 'Rebooted the device', '2025-08-09 01:20:48', '2025-08-13 11:11:16', 60);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (6, 9, '503 Service Unavailable', 'Cleared cache and cookies', '2025-11-29 19:51:03', '2025-12-29 17:43:43', 95);
...
insert into error (systemID, updateID, errorType, errorSolution, timeReported, timeSolved, errorID) values (10, 4, '500 Internal Server Error', 'Rebooted the device', '2025-09-25 14:31:22', '2025-10-12 00:31:23', 79);
